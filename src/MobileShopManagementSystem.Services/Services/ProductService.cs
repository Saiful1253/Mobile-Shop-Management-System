...
namespace MobileShopManagementSystem.Services.Services
{
    public class ProductService : IProductService
    {
        ...
        public Task<IEnumerable<Product>> GetByBrandAsync(int brandId) => _repository.GetByBrandAsync(brandId);
        public Task<IEnumerable<Product>> GetByCategoryAsync(int categoryId) => _repository.GetByCategoryAsync(categoryId);
    }
}
